			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="instructorNo" title="${message(code: 'instructor.instructorNo.label', default: 'Instructor No')}" />
				...
				<g:each in="${instructorInstanceList}" status="i" var="instructorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${instructorInstance.id}">${fieldValue(bean: instructorInstance, field: "instructorNo")}</g:link></td>
