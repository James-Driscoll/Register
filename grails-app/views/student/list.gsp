			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="studentNo" title="${message(code: 'student.studentNo.label', default: 'Student No')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${studentInstance.id}">${fieldValue(bean: studentInstance, field: "studentNo")}</g:link></td>
